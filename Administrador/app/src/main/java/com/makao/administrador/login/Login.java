...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtRecuperar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Login.this, OllvidasteContrasena.class);
                startActivity(i);
            }
        });
    ...
    public void ValidarUsuario(final String usuario, final String contrasena) {
        ...
        String url = Utils.RUTA_APIS + "ValidarAdminUsuarioContrasena.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Login.this, "Error en la solicitud", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
