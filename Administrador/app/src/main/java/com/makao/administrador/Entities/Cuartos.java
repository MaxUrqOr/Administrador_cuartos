...
public class Cuartos {
    ...
    public Cuartos(int idCuarto, int idInquilino, String codigoCua, String tamanoCua,
                   String pisoCua, int costoCua, String estado_Cua, int garantia_Cua,
                   String dniInq, String nombreInq, String telefonoInq, String fechaIngresoInq) {
        this.idCuarto = idCuarto;
        this.idInquilino = idInquilino;
        this.codigoCua = codigoCua;
        this.tamanoCua = tamanoCua;
    ...
    public int getGarantia_Cua() {
        return Garantia_Cua;
    }

    public void setGarantia_Cua(int garantia_Cua) {
        Garantia_Cua = garantia_Cua;
    }
