...
public class lista_makao_t2 extends Fragment {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        // Verificar y asignar NOMBRE_INQ
                        ...
                        cuartos.setFechaIngresoInq(jsonObject.optString("FECHAINGRESO_INQ", " ")); // Valor predeterminado como cadena vacía si es nulo
