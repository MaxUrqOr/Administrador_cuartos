...
import com.makao.administrador.navegacion.listas.lista_makao_t2_a;
import com.makao.administrador.navegacion.listas.lista_parque_t2_a;
...
public class Pagos extends Fragment {
    ...
    private void showFragmentParque() {
        Fragment parqueFragment = new lista_parque_t2_a();
    ...
    private void showFragmentMakao() {
        Fragment makaoFragment = new lista_makao_t2_a();
        FragmentTransaction transaction = getFragmentManager().beginTransaction();
