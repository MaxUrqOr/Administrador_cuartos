...
public class lista_makao extends Fragment {
    RecyclerView rclMakao;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_lista_makao, container, false);

        // Inicializar RecyclerView
        rclMakao = vista.findViewById(R.id.rclMakao);
        ...
        jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    rclMakao.setLayoutManager(new LinearLayoutManager(getActivity()));
                    rclMakao.setAdapter(adapter);
                }
