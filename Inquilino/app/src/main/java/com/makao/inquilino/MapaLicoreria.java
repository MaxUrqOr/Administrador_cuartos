...
public class MapaLicoreria extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private com.makao.inquilino.databinding.ActivityMapaLicoreriaBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = com.makao.inquilino.databinding.ActivityMapaLicoreriaBinding.inflate(getLayoutInflater());
...
//         Obtain the SupportMapFragment and get notified when the map is ready to be used.
        ...
        AppCompatButton btnRegresar = findViewById(R.id.btnRegresar);
